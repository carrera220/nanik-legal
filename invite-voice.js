 ...
 * tip + sample glow + Start/Stop). Recording ends ONLY when the user taps Stop
 * — there is no countdown and no auto-stop timer.
 */
(function () {
  var MIN_MS = 5000;
  ...
  function tick() {
    ...
    // Metering only — never auto-stop here.
  ...
  function startMicAndRecorder() {
    ...
    return navigator.mediaDevices
      ...
      .then(function (mediaStream) {
        ...
        // If the browser ends the recorder unexpectedly, do not treat it as Stop.
        mediaRecorder.onstop = function () {
          if (!stopRequested && phase === 'recording') {
  ...
  function finishRecordingToSave() {
    ...
    stopRecorder()
      ...
      .catch(function (err) {
        console.error('[invite-voice]', err);
