...
(function (global) {
  ...
  var SAMPLES = {
    hy: "— Ա՜խ, իմ սիրելի՛ փոքրիկ, հիմա քեզ կպատմեմ մի անուշ հեքիաթ։ Տեսնես ի՞նչ աշխարհ է քեզ սպասում, և ու՞ր է երազը քեզ տանելու։",
    en: "Everyone thought the little dragon was fast asleep in his bed...\nBut look up there!\nHe's flying right over the moon!\nCan you see him waving?",
    ru: "Все думали, что маленький дракон крепко спит в своей кроватке… а посмотрите наверх! Он летит прямо над луной! Видишь, как он машет?",
  };
